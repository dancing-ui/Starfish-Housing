...
void CarouselImageWindow::paintEvent(QPaintEvent* )
{
...
void CarouselImageWindow::mousePressEvent(QMouseEvent* )
{
    // 这里可以对当前图片进行点击然后触发每个图片对应的效果;
    // 比如web上好多类似的弹出对应的广告页面等功能;
    qDebug() <<"当前封面显示的图片编号："<< m_currentDrawImageIndx;
}
